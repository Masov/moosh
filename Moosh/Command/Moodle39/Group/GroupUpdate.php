...
class GroupUpdate extends MooshCommand
{
    public function __construct()
    {
        parent::__construct('update', 'group');
    ...
    public function execute()
    {
        ...
        $group = new \stdClass();
        $group->courseid = $this->arguments[2];
        $group->name = $this->arguments[1];
